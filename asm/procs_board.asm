...
# pause_and_getkey:  RESPONSIVE keyboard read + pause combined (not used)
# pause_and_getkey_2player:  RESPONSIVE keyboard read + pause combined for 2 players (not used)
...
# put_sound:     sets sound generator tone
...
.eqv screen_base 0x10020000 		# Base addr of smem
...
.data
key_array: .word 0x1D, 0x1B, 0x5B  # w, s, ]
key_array_end:	    # marks end of key array


.eqv keyb_mmio 0x10030000 		#  memory map
...
.data
key_array2:	.word	0x3B, 0x4B, 0x43, 0x42   	# scancodes
key_array_end2:
...
get_key_loop2:				# iterate through key_array for match
	lw	$t0, key_array2($v0)
	addi	$v0, $v0, 4		# go to next array element
...
.eqv accel_mmio 0x10030004 		#  memory map
...
.eqv sound_mmio 0x10030008 		#  memory map
...
.eqv leds_mmio 0x1003000C 		# memory map
